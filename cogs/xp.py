...
class XpCog(commands.Cog):
    ...
    @app_commands.command(name='xp_resetar', description='Resetar a quantidade de xp de um membro')
    async def resetXp(self, ctx: discord.Interaction, member: discord.Member):
        pass

    @app_commands.command(name='xp_resetar_todos', description='Resetar a quantidade de xp de todos os membros')
    async def resetAllXp(self, ctx: discord.Interaction):
        pass

    @app_commands.command(name='xp_adicionar', description='Adiciona xp a um membro')
    ...
    @app_commands.command(name='rp_inventario', description='Mostra os itens que você possui')
    async def inventory(self, ctx: discord.Interaction):
        pass

    @app_commands.command(name='rp_usar', description='Usa um item do seu inventário')
    async def useItem(self, ctx: discord.Interaction, item: str):
        pass

    @app_commands.command(name='rp_vender', description='Vende um item do seu inventário')
    ...
    @app_commands.command(name='rp_trabalhar', description='Trabalha em troca de xp e dinheiro')
    async def work(self, ctx: discord.Interaction):
        pass

    @app_commands.command(name='rp_duelo', description='Desafie alguém para um duelo')
    async def duel(self, ctx: discord.Interaction, member: discord.Member):
        pass

    @app_commands.command(name='rp_desenhar', description='Desenhe algo!')
