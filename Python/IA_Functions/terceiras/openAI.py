    ...
    try:
        ...
        if app == 'Discord':
            ...
            async for msg in channel.history(limit=7):
                historico.append({'nome': msg.author.name, 'mensagem': msg.content, 'in_response_to': msg.reference})
            ...
            messages = [
                {
                    ...
                    "content": f'''
                        ...
                        Seja sempre muito gentil, educado, atencioso e respeitoso com todos, pois você é o pet que representa a comunidade BraFurries.
